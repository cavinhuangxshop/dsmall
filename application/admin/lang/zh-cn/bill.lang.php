...
$lang['bill_show_statis_help1']            = '此处列出了详细的店铺账单信息，点击查看可以查看详细的订单信息、退单信息和店铺费用信息';
$lang['bill_show_statis_help2']            = '账单处理流程为：系统出账 > 商家确认 > 平台审核 > 财务支付(完成结算) 4个环节，其中平台审核和财务支付需要平台介入，请予以关注';
$lang['bill_order']           = '账单';
