...
//            }
    ...
    public function store_bind_class_applay_del() {
        ...
        if ($del) {
            ...
            $this->success(lang('ds_common_del_succ'), get_referer());
        } else {
    ...
    public function reopen_check() {
        ...
        if ($update) {
            ...
            $this->log($msg, 1);
            $this->success('续签成功，店铺有效成功延续到了' . date('Y-m-d', $new_store_endtime) . '日', get_referer());
        } else {
            $this->error('审核失败', get_referer());
        }
    }
    ...
    private function store_joinin_verify_pass($joinin_detail) {
        ...
        if ($param['paying_amount'] > 0) {
            $this->success('店铺入驻申请审核完成', url('Store/store_joinin'));
        } else {
    ...
    private function store_joinin_verify_open($joinin_detail) {
        ...
        if (input('post.verify_type') === 'pass') {
            ...
            if ($state) {
                ...
                $this->success('店铺开店成功', url('Store/store_joinin'));
            } else {
                $this->error('店铺开店失败', url('Store/store_joinin'));
            }
        } else {
            $this->error('店铺开店拒绝', url('Store/store_joinin'));
        }
    }
    ...
    public function del() {
        ...
        $this->success(lang('ds_common_op_succ'), get_referer());
    }
