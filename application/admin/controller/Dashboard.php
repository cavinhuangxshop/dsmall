...
class Dashboard extends AdminControl {
    ...
    public function statistics() {
        ...
        $statistics['check_billno'] += $vrbill_model->getVrorderbillCount(array('vrob_state'=>BILL_STATE_STORE_COFIRM));
        //待支付账单
        $statistics['pay_billno'] = $bill_model->getOrderbillCount(array('ob_state'=>BILL_STATE_STORE_COFIRM));
        $statistics['pay_billno'] += $vrbill_model->getVrorderbillCount(array('vrob_state'=>BILL_STATE_STORE_COFIRM));
        // 平台客服
