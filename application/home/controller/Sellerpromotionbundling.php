...
class Sellerpromotionbundling extends BaseSeller
{
    ...
    public function bundling_quota_add()
    {
        if (request()->isPost()) {
            ...
            if ($quantity <= 0 || $quantity > 12) {
                ds_show_dialog(lang('bundling_quota_price_fail'), url('Sellerpromotionbundling/bundling_quota_add'), '', 'error');
            }
            // 实例化模型
            $pbundling_model = model('pbundling');
            ...
            if ($return) {
                ...
                ds_show_dialog(lang('bundling_quota_price_succ'), url('Sellerpromotionbundling/index'), 'succ');
            }
            else {
                ds_show_dialog(lang('bundling_quota_price_fail'), url('Sellerpromotionbundling/bundling_quota_add'));
            }
        }
        // 输出导航
        $this->setSellerCurMenu('Sellerpromotionbundling');
    ...
    public function bundling_add()
    {
        ...
        if (request()->isPost()) {
            ...
            ds_show_dialog(lang('ds_common_op_succ'), url('Sellerpromotionbundling/index'), 'succ');
        } else {
            // 是否能使用编辑器
    ...
    public function drop_bundling()
    {
        ...
        if ($return) {
            ...
            ds_show_dialog(lang('bundling_delete_success'), 'reload', 'succ');
        }
        else {
            ds_show_dialog(lang('bundling_delete_fail'), '', 'error');
        }
    }
