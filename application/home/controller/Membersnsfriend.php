...
class Membersnsfriend extends BaseMember {
    ...
    public function _initialize() {
        ...
        Lang::load(APP_PATH . 'home/lang/zh-cn/member_snsfriend.lang.php');
    }
    ...
    public function addfollow() {
        ...
        if (empty($member_list)) {
            ds_show_dialog(lang('snsfriend_member_error'), '', 'error');
        }
        $self_info = array();
        $member_info = array();
        ...
        if ($friend_count > 0) {
            ds_show_dialog(lang('snsfriend_havefollowed'), '', 'error');
        }
        ...
        echo input('param.callback') ? input('param.callback') . '(' . $return . ')' : $return;
        exit;
    }
    ...
    public function batch_addfollow() {
        ...
        ds_show_dialog(lang('snsfriend_follow_succ'), '', 'succ');
    }
