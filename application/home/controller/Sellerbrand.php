...
class Sellerbrand extends BaseSeller {
    ...
    public function brand_save() {
        ...
        if (request()->isPost()) {
            ...
            if ($result) {
                ds_show_dialog(lang('store_goods_brand_apply_success'), url('Sellerbrand/index'), 'succ', empty(input('param.inajax')) ? '' : 'CUR_DIALOG.close();');
            } else {
    ...
    public function brand_edit() {
        ...
        if (request()->isPost()) {
            ...
            if (!$error) {
                ...
                if ($result) {
                    ds_show_dialog(lang('ds_common_save_succ'), url('Sellerbrand/index'), 'succ', empty(input('param.inajax')) ? '' : 'CUR_DIALOG.close();');
                } else {
                    ds_show_dialog(lang('ds_common_save_fail'));
                }
            }
    ...
    public function drop_brand() {
        ...
        if ($brand_id > 0) {
            ...
            ds_show_dialog(lang('ds_common_del_succ'), url('Sellerbrand/index'), 'succ');
        } else {
