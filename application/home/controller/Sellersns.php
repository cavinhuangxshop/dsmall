...
class Sellersns extends BaseSeller {
    ...
    public function store_sns_save() {
       ...
       $error=$obj_validate->check($data,$message);
        ...
        switch ($type) {
            ...
            case '10':
                if (is_array($_POST['goods_id'])) {
                    ...
                    ds_show_dialog(lang('store_sns_choose_goods'));
                }
            ...
            case '3':
                ...
                break;
            default:
                ds_show_dialog(lang('para_error'));
        }
        ...
        if ($rs) {
            ds_show_dialog(lang('ds_common_op_succ'), url('Sellersns/index'), 'succ');
        } else {
    ...
    public function setting() {
        ...
        if (request()->isPost()) {
            ...
            if($result>=0){
                ds_show_dialog(lang('ds_common_save_succ'), url('Sellersns/setting'), 'succ');
            }else {
                ds_show_dialog(lang('ds_common_save_fail'), url('Sellersns/setting'), 'error');
            }
        } else {
    ...
    private function getGoodsByUrl($url) {
        ...
        if (intval($id) > 0) {
            ...
            if (!empty($result) && is_array($result)) {
                ...
                ds_show_dialog(lang('store_sns_goods_url_error'));
            }
        } else {
            ds_show_dialog(lang('store_sns_goods_url_error'));
        }
