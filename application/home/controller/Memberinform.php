...
class Memberinform extends BaseMember {
    ...
    public function inform_save() {
        ...
        $rule = [
            ...
            ['informsubject_content', 'require|max:50|min:1', lang('para_error')]
        ];
    ...
    public function inform_cancel() {
        ...
        if (intval($inform_info['inform_state']) === 1) {
            ...
            ds_show_dialog(lang('inform_cancel_success'), 'reload', 'succ');
        } else {
            ds_show_dialog(lang('inform_cancel_fail'), '', 'error');
        }
    }
