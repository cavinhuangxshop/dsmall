...
class Sellerconsult extends BaseSeller
{
    ...
    public function drop_consult()
    {
        ...
        if ($state) {
            ds_show_dialog(lang('store_consult_drop_success'), 'reload', 'succ');
        }
        else {
            ds_show_dialog(lang('store_consult_drop_fail'));
        }
    }
    ...
    public function reply_save()
    {
        ...
        if ($state) {
            ...
            ds_show_dialog(lang('ds_common_op_succ'), 'reload', 'succ', empty(input('get.inajax')) ? '' : 'CUR_DIALOG.close();');
        }
        else {
