...
class Selleralbum extends BaseSeller {
    ...
    public function album_add_save() {
        if (request()->isPost()) {
            ...
            if ($class_count['count'] >= 20) {
                ds_show_dialog(lang('album_class_save_max_20'), url('Selleralbum/index'), 'error', !input('param.inajax') ? '' : 'CUR_DIALOG.close();');
            }
            /**
             * 实例化相册模型
             */
            ...
            if ($return) {
                ds_show_dialog(lang('album_class_save_succeed'), url('Selleralbum/index'), 'succ', empty(input('param.inajax')) ? '' : 'CUR_DIALOG.close();');
            }
        }
    ...
    public function album_edit_save() {
        ...
        if ($return) {
            ...
            if ($re) {
                ds_show_dialog(lang('album_class_edit_succeed'), url('Selleralbum/index'), 'succ', empty(input('get.inajax')) ? '' : 'CUR_DIALOG.close();');
            }
        } else {
    ...
    public function album_del() {
        ...
        if ($return) {
            ds_show_dialog(lang('album_class_file_del_succeed'), url('Selleralbum/index'), 'succ');
        } else {
            ds_show_dialog(lang('album_class_file_del_lose'));
        }
    }
    ...
    public function album_pic_del() {
        ...
        if ($return) {
            ...
            ds_show_dialog(lang('album_class_pic_del_lose'));
        }
    }
    ...
    public function album_pic_move() {
        ...
        if (request()->isPost()) {
            ...
            if ($return) {
                ds_show_dialog(lang('album_class_pic_move_succeed'), 'reload', 'succ');
            } else {
                ds_show_dialog(lang('album_class_pic_move_lose'));
            }
        } else {
            $id = input('param.id');
            $cid = input('param.cid');
    ...
    public function album_pic_watermark() {
        ...
        if ($store_wm_info['swm_image_name'] == '' && $store_wm_info['swm_text'] == '') {
            ds_show_dialog(lang('album_class_setting_wm'), url('Selleralbum/store_watermark'), 'error', 'CUR_DIALOG.close();'); //"请先设置水印"
        }
        ...
        ds_show_dialog(lang('album_pic_plus_wm_succeed'), 'reload', 'succ');
    }
    ...
    public function store_watermark() {
        ...
        if (!request()->isPost()) {
            ...
            if ($result) {
                ds_show_dialog(lang('store_watermark_congfig_success'), 'reload', 'succ');
            } else {
                ds_show_dialog(lang('store_watermark_congfig_fail'));
            }
        }
    }
