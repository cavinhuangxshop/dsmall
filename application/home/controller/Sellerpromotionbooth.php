    ...
    public function booth_quota_add()
    {
        if (request()->isPost()) {
            ...
            if ($quantity <= 0 || $quantity > 12) {
                ds_show_dialog('参数错误，购买失败。', url('Sellerpromotionbooth/booth_quota_add'), '', 'error');
            }
            // 实例化模型
            $pbooth_model = model('pbooth');
            ...
            if ($return) {
                ...
                ds_show_dialog('购买成功', url('Sellerpromotionbooth/index'), 'succ');
            }
            else {
                ds_show_dialog('购买失败', url('Sellerpromotionbooth/booth_quota_add'));
            }
        }
        // 输出导航
        $this->setSellerCurMenu('Sellerpromotionbooth');
