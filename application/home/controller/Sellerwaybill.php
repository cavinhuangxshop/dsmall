...
class Sellerwaybill extends BaseSeller
{
        ...
        if(!empty($express_list)) {
            foreach ($express_list as $key => $value) {
                if(!empty($storewaybill_list[$value['express_id']])) {
                    ...
                    $express_list[$key]['is_default_text'] =  $storewaybill_list[$value['express_id']]['storewaybill_isdefault'] ? '是' : '否';
    ...
    public function waybill_setting_save() {
        ...
        if($result) {
            ds_show_dialog(lang('ds_common_save_succ'),url('Sellerwaybill/index'));
        } else {
    ...
    public function waybill_set_default() {
        ...
        if($result) {
            ds_show_dialog(lang('ds_common_save_succ'),url('Sellerwaybill/index'),'succ');
        } else {
            ds_show_dialog(lang('ds_common_save_fail'),url('Sellerwaybill/index'),'error');
        }
    }
    ...
    public function waybill_save() {
        ...
        if(!isset($result['error'])) {
            ds_show_dialog(lang('ds_common_save_succ'), url('Sellerwaybill/waybill_list'),'succ');
        } else {
            ds_show_dialog(lang('ds_common_save_fail'), url('Sellerwaybill/waybill_list'));
        }
    }
