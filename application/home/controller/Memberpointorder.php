...
class Memberpointorder extends BaseMember
{
    ...
    public function cancel_order()
    {
        ...
        if ($data['state']) {
            ds_show_dialog(lang('member_pointorder_cancel_success'), url('Memberpointorder/index'), 'succ');
        } else {
            ds_show_dialog($data['msg'], url('Memberpointorder/index'), 'error');
        }
    }
    ...
    public function receiving_order()
    {
        ...
        if ($data['state']) {
            ds_show_dialog(lang('member_pointorder_confirmreceiving_success'), url('Memberpointorder/index'), 'succ');
        } else {
            ds_show_dialog($data['msg'], url('Memberpointorder/index'), 'error');
        }
    }
    ...
    public function order_info()
    {
        ...
        if ($order_id <= 0) {
            ds_show_dialog(lang('member_pointorder_parameter_error'), url('Memberpointorder/index'), 'error');
        }
        $pointorder_model = model('pointorder');
        //查询兑换订单信息
        $where = array();
