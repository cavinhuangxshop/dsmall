...
CREATE TABLE `#__orderbill` (
  ...
  `ob_paydate` int(11) DEFAULT '0' COMMENT '结算付款日期',
  `ob_pay_content` varchar(200) DEFAULT '' COMMENT '结算支付备注',
...
CREATE TABLE `#__orderstatis` (
  ...
  `os_startdate` int(11) NOT NULL COMMENT '开始日期',
  `os_enddate` int(11) NOT NULL COMMENT '结束日期',
...
DROP TABLE IF EXISTS `#__snsbinding`;
CREATE TABLE `#__snsbinding` (
...
DROP TABLE IF EXISTS `#__snscomment`;
CREATE TABLE `#__snscomment` (
...
DROP TABLE IF EXISTS `#__snsgoods`;
CREATE TABLE `#__snsgoods` (
...
DROP TABLE IF EXISTS `#__snssharegoods`;
CREATE TABLE `#__snssharegoods` (
...
DROP TABLE IF EXISTS `#__snssharestore`;
CREATE TABLE `#__snssharestore` (
...
DROP TABLE IF EXISTS `#__snstracelog`;
CREATE TABLE `#__snstracelog` (
...
DROP TABLE IF EXISTS `#__snsvisitor`;
CREATE TABLE `#__snsvisitor` (
...
DROP TABLE IF EXISTS `#__vrorderbill`;
CREATE TABLE `#__vrorderbill` (
...
DROP TABLE IF EXISTS `#__vrorderstatis`;
CREATE TABLE `#__vrorderstatis` (
...
(62, 'oss_accessid', NULL, 'accessid'),
(63, 'oss_accesssecret', NULL, 'oss_accesssecret'),
(64, 'oss_bucket', NULL, 'oss_bucket'),
(65, 'oss_endpoint', NULL, 'oss_endpoint'),
(66, 'endpoint_type', '0', 'endpoint_type'),
